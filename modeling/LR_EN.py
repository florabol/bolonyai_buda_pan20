...
data_v1=pd.read_csv('/content/drive/My Drive/PAN20/data/clean_en_data_v1.tsv',delimiter='\t', encoding='utf-8')
data_v2=pd.read_csv('/content/drive/My Drive/PAN20/data/clean_en_data_v2.tsv',delimiter='\t', encoding='utf-8')
...
print(time.strftime("%m/%d/%Y %H:%M:%S"))
filename='/content/drive/My Drive/PAN20/normalized_v1_gs.pickle' #saving out gridsearch
...
v1_df.to_csv('/content/drive/My Drive/PAN20/lr_tfidf_results_v1.tsv', sep='\t', index=False)
...
print(time.strftime("%m/%d/%Y %H:%M:%S"))
filename='/content/drive/My Drive/PAN20/normalized_v2_gs.pickle'
pickle.dump(lr_tfidf_v1, open(filename, 'wb'))
v2_df=pd.DataFrame()
v2_df['params']=lr_tfidf_v1.cv_results_['params']
v2_df['scores']=lr_tfidf_v1.cv_results_['mean_test_score']
v2_df.to_csv('/content/drive/My Drive/PAN20/lr_tfidf_results_v2.tsv', sep='\t', index=False)