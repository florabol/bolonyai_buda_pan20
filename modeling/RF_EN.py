...
rf_results_v1.to_csv('/content/drive/My Drive/PAN20/rf_tfidf_results_v1.tsv', sep='\t', index=False)
...
rf_results_v2.to_csv('/content/drive/My Drive/PAN20/rf_tfidf_results_v2.tsv', sep='\t', index=False)