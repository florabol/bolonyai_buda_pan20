...
filename='/content/drive/My Drive/PAN20/svm_tfidf_1_cs.pickle'
...
v1_df.to_csv('/content/drive/My Drive/PAN20/svm_tfidf_results_v1.tsv', sep='\t', index=False)
...
filename='/content/drive/My Drive/PAN20/svm_tfidf_2_cs.pickle'
...
v2_df.to_csv('/content/drive/My Drive/PAN20/svm_tfidf_results_v2.tsv', sep='\t', index=False)